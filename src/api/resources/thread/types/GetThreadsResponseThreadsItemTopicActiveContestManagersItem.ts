 ...
 */
export interface GetThreadsResponseThreadsItemTopicActiveContestManagersItem {
    ...
    content: CommonApi.GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItem[];
}
