 ...
 */
export interface GetThreadsResponseResultsItemTopicActiveContestManagersItem {
    ...
    environment?: CommonApi.GetThreadsResponseResultsItemTopicActiveContestManagersItemEnvironment;
    deleted_at?: string;
    content: CommonApi.GetThreadsResponseResultsItemTopicActiveContestManagersItemContentItem[];
}
