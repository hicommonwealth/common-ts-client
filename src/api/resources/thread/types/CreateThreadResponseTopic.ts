...
export interface CreateThreadResponseTopic {
    id?: number;
    name?: string;
    community_id: string;
    description?: string;
    ...
    weighted_voting?: CommonApi.CreateThreadResponseTopicWeightedVoting;
    ...
    updated_at?: string;
    deleted_at?: string;
    contest_topics?: CommonApi.CreateThreadResponseTopicContestTopicsItem[];
}
