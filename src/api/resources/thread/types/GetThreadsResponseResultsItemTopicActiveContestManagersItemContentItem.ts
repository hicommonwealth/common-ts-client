 ...
 */
export interface GetThreadsResponseResultsItemTopicActiveContestManagersItemContentItem {
    ...
    action: CommonApi.GetThreadsResponseResultsItemTopicActiveContestManagersItemContentItemAction;
    /** Content url */
    content_url?: string;
