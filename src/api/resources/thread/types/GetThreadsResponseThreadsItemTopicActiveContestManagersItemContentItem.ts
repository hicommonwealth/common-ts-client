 ...
 */
export interface GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItem {
    ...
    action: CommonApi.GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItemAction;
    /** Content url */
    content_url?: string;
