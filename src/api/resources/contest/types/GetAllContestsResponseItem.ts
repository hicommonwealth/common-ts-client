 ...
 */
export interface GetAllContestsResponseItem {
    ...
    ended?: boolean;
    contests: CommonApi.GetAllContestsResponseItemContestsItem[];
    farcaster_frame_url?: string;
    farcaster_frame_hashes?: string[];
    topic_id?: number;
    topics: CommonApi.GetAllContestsResponseItemTopicsItem[];
    ...
    environment?: CommonApi.GetAllContestsResponseItemEnvironment;
