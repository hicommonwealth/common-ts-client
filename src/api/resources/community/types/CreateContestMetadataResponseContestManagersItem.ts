 ...
 */
export interface CreateContestMetadataResponseContestManagersItem {
    ...
    ended?: boolean;
    contests?: CommonApi.CreateContestMetadataResponseContestManagersItemContestsItem[];
    farcaster_frame_url?: string;
    farcaster_frame_hashes?: string[];
    topic_id?: number;
    topics?: CommonApi.CreateContestMetadataResponseContestManagersItemTopicsItem[];
    ...
    environment?: CommonApi.CreateContestMetadataResponseContestManagersItemEnvironment;
