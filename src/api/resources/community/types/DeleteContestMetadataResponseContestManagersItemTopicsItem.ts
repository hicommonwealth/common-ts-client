...
export interface DeleteContestMetadataResponseContestManagersItemTopicsItem {
    id?: number;
    name?: string;
    community_id: string;
    description?: string;
    ...
    weighted_voting?: CommonApi.DeleteContestMetadataResponseContestManagersItemTopicsItemWeightedVoting;
