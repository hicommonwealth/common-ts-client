 ...
 */
export interface DeleteContestMetadataResponseContestManagersItem {
    ...
    ended?: boolean;
    contests?: CommonApi.DeleteContestMetadataResponseContestManagersItemContestsItem[];
    farcaster_frame_url?: string;
    farcaster_frame_hashes?: string[];
    topic_id?: number;
    topics?: CommonApi.DeleteContestMetadataResponseContestManagersItemTopicsItem[];
    ...
    environment?: CommonApi.DeleteContestMetadataResponseContestManagersItemEnvironment;
