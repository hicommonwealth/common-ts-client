 ...
 */
export interface DeleteContestMetadataResponseContestManagersItemContestsItemActionsItem {
    ...
    action: CommonApi.DeleteContestMetadataResponseContestManagersItemContestsItemActionsItemAction;
    /** Content url */
    content_url?: string;
