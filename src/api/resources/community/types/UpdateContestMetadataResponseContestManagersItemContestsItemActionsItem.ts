 ...
 */
export interface UpdateContestMetadataResponseContestManagersItemContestsItemActionsItem {
    ...
    action: CommonApi.UpdateContestMetadataResponseContestManagersItemContestsItemActionsItemAction;
    /** Content url */
    content_url?: string;
