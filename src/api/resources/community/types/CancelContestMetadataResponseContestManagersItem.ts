 ...
 */
export interface CancelContestMetadataResponseContestManagersItem {
    ...
    ended?: boolean;
    contests?: CommonApi.CancelContestMetadataResponseContestManagersItemContestsItem[];
    farcaster_frame_url?: string;
    farcaster_frame_hashes?: string[];
    topic_id?: number;
    topics?: CommonApi.CancelContestMetadataResponseContestManagersItemTopicsItem[];
    ...
    environment?: CommonApi.CancelContestMetadataResponseContestManagersItemEnvironment;
