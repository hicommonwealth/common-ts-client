 ...
 */
export interface GetCommunitiesResponseResultsItemContestManagersItemContestsItemActionsItem {
    ...
    action: CommonApi.GetCommunitiesResponseResultsItemContestManagersItemContestsItemActionsItemAction;
    /** Content url */
    content_url?: string;
