 ...
 */
export interface CancelContestMetadataResponseContestManagersItemContestsItemActionsItem {
    ...
    action: CommonApi.CancelContestMetadataResponseContestManagersItemContestsItemActionsItemAction;
    /** Content url */
    content_url?: string;
