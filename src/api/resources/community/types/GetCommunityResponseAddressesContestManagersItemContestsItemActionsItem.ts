 ...
 */
export interface GetCommunityResponseAddressesContestManagersItemContestsItemActionsItem {
    ...
    action: CommonApi.GetCommunityResponseAddressesContestManagersItemContestsItemActionsItemAction;
    /** Content url */
    content_url?: string;
