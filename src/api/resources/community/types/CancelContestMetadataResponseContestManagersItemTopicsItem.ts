...
export interface CancelContestMetadataResponseContestManagersItemTopicsItem {
    id?: number;
    name?: string;
    community_id: string;
    description?: string;
    ...
    weighted_voting?: CommonApi.CancelContestMetadataResponseContestManagersItemTopicsItemWeightedVoting;
