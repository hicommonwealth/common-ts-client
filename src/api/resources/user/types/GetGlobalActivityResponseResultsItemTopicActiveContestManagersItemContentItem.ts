 ...
 */
export interface GetGlobalActivityResponseResultsItemTopicActiveContestManagersItemContentItem {
    ...
    action: CommonApi.GetGlobalActivityResponseResultsItemTopicActiveContestManagersItemContentItemAction;
    /** Content url */
    content_url?: string;
