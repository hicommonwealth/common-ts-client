 ...
 */
export interface GetUserActivityResponseResultsItemTopicActiveContestManagersItemContentItem {
    ...
    action: CommonApi.GetUserActivityResponseResultsItemTopicActiveContestManagersItemContentItemAction;
    /** Content url */
    content_url?: string;
