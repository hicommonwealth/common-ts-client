 ...
 */
export interface GetUserActivityResponseResultsItemTopicActiveContestManagersItem {
    ...
    environment?: CommonApi.GetUserActivityResponseResultsItemTopicActiveContestManagersItemEnvironment;
    deleted_at?: string;
    content: CommonApi.GetUserActivityResponseResultsItemTopicActiveContestManagersItemContentItem[];
}
