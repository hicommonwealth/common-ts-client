...
import { CreateThreadResponseReactionAddressWalletId } from "./CreateThreadResponseReactionAddressWalletId";
import { CreateThreadResponseReactionAddressRole } from "./CreateThreadResponseReactionAddressRole";
import { CreateThreadResponseReactionAddressUser } from "./CreateThreadResponseReactionAddressUser";

export const CreateThreadResponseReactionAddress: core.serialization.ObjectSchema<
    serializers.CreateThreadResponseReactionAddress.Raw,
    CommonApi.CreateThreadResponseReactionAddress
> = core.serialization.object({
    ...
    walletId: core.serialization.property("wallet_id", CreateThreadResponseReactionAddressWalletId.optional()),
    ...
    role: CreateThreadResponseReactionAddressRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", CreateThreadResponseReactionAddressUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace CreateThreadResponseReactionAddress {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: CreateThreadResponseReactionAddressWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: CreateThreadResponseReactionAddressRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: CreateThreadResponseReactionAddressUser.Raw | null;
