...
import { CreateThreadResponseTopicWeightedVoting } from "./CreateThreadResponseTopicWeightedVoting";

export const CreateThreadResponseTopic: core.serialization.ObjectSchema<
    serializers.CreateThreadResponseTopic.Raw,
    CommonApi.CreateThreadResponseTopic
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property("weighted_voting", CreateThreadResponseTopicWeightedVoting.optional()),
...
export declare namespace CreateThreadResponseTopic {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: CreateThreadResponseTopicWeightedVoting.Raw | null;
