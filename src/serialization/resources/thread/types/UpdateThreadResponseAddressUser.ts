...
export const UpdateThreadResponseAddressUser: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    emailNotificationInterval: UpdateThreadResponseAddressUserEmailNotificationInterval.optional(),
    ...
    profile: UpdateThreadResponseAddressUserProfile,
    xpPoints: core.serialization.property("xp_points", core.serialization.number().optional()),
    profileTags: core.serialization.property(
        "ProfileTags",
        core.serialization.list(UpdateThreadResponseAddressUserProfileTagsItem).optional()
    ),
    apiKey: core.serialization.property("ApiKey", UpdateThreadResponseAddressUserApiKey.optional()),
