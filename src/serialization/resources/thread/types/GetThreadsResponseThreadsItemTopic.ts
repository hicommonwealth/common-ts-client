...
import { GetThreadsResponseThreadsItemTopicWeightedVoting } from "./GetThreadsResponseThreadsItemTopicWeightedVoting";
import { GetThreadsResponseThreadsItemTopicActiveContestManagersItem } from "./GetThreadsResponseThreadsItemTopicActiveContestManagersItem";

export const GetThreadsResponseThreadsItemTopic: core.serialization.ObjectSchema<
    serializers.GetThreadsResponseThreadsItemTopic.Raw,
    CommonApi.GetThreadsResponseThreadsItemTopic
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        GetThreadsResponseThreadsItemTopicWeightedVoting.optional()
    ),
    ...
    activeContestManagers: core.serialization.property(
        ...
        core.serialization.list(GetThreadsResponseThreadsItemTopicActiveContestManagersItem).optional()
    ),
});

export declare namespace GetThreadsResponseThreadsItemTopic {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: GetThreadsResponseThreadsItemTopicWeightedVoting.Raw | null;
        ...
        active_contest_managers?: GetThreadsResponseThreadsItemTopicActiveContestManagersItem.Raw[] | null;
    }
}
