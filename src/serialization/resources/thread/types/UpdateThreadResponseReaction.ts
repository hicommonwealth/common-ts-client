...
import { UpdateThreadResponseReactionAddress } from "./UpdateThreadResponseReactionAddress";

export const UpdateThreadResponseReaction: core.serialization.ObjectSchema<
    serializers.UpdateThreadResponseReaction.Raw,
    CommonApi.UpdateThreadResponseReaction
> = core.serialization.object({
    ...
    address: core.serialization.property("Address", UpdateThreadResponseReactionAddress.optional()),
});

export declare namespace UpdateThreadResponseReaction {
    interface Raw {
        id?: number | null;
        address_id: number;
        reaction: "like";
        ...
        Address?: UpdateThreadResponseReactionAddress.Raw | null;
    }
}
