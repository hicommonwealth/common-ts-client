...
import { UpdateThreadResponseReactionAddressWalletId } from "./UpdateThreadResponseReactionAddressWalletId";
import { UpdateThreadResponseReactionAddressRole } from "./UpdateThreadResponseReactionAddressRole";
import { UpdateThreadResponseReactionAddressUser } from "./UpdateThreadResponseReactionAddressUser";

export const UpdateThreadResponseReactionAddress: core.serialization.ObjectSchema<
    serializers.UpdateThreadResponseReactionAddress.Raw,
    CommonApi.UpdateThreadResponseReactionAddress
> = core.serialization.object({
    ...
    walletId: core.serialization.property("wallet_id", UpdateThreadResponseReactionAddressWalletId.optional()),
    ...
    role: UpdateThreadResponseReactionAddressRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", UpdateThreadResponseReactionAddressUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace UpdateThreadResponseReactionAddress {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: UpdateThreadResponseReactionAddressWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: UpdateThreadResponseReactionAddressRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: UpdateThreadResponseReactionAddressUser.Raw | null;
