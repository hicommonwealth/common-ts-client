...
import { GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItem } from "./GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItem";

export const GetThreadsResponseThreadsItemTopicActiveContestManagersItem: core.serialization.ObjectSchema<
    serializers.GetThreadsResponseThreadsItemTopicActiveContestManagersItem.Raw,
    CommonApi.GetThreadsResponseThreadsItemTopicActiveContestManagersItem
> = core.serialization.object({
    ...
    contests: core.serialization.unknown().optional(),
    ...
    topics: core.serialization.unknown().optional(),
    isFarcasterContest: core.serialization.property("is_farcaster_contest", core.serialization.boolean()),
    content: core.serialization.list(GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItem),
});

export declare namespace GetThreadsResponseThreadsItemTopicActiveContestManagersItem {
    interface Raw {
        ...
        content: GetThreadsResponseThreadsItemTopicActiveContestManagersItemContentItem.Raw[];
    }
}
