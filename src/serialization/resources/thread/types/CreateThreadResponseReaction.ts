...
import { CreateThreadResponseReactionAddress } from "./CreateThreadResponseReactionAddress";

export const CreateThreadResponseReaction: core.serialization.ObjectSchema<
    serializers.CreateThreadResponseReaction.Raw,
    CommonApi.CreateThreadResponseReaction
> = core.serialization.object({
    ...
    address: core.serialization.property("Address", CreateThreadResponseReactionAddress.optional()),
});

export declare namespace CreateThreadResponseReaction {
    interface Raw {
        id?: number | null;
        address_id: number;
        reaction: "like";
        ...
        Address?: CreateThreadResponseReactionAddress.Raw | null;
    }
}
