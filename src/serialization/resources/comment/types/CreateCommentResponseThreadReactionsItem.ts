...
export const CreateCommentResponseThreadReactionsItem: core.serialization.ObjectSchema<
    serializers.CreateCommentResponseThreadReactionsItem.Raw,
    CommonApi.CreateCommentResponseThreadReactionsItem
> = core.serialization.object({
    ...
    address: core.serialization.property("Address", CreateCommentResponseThreadReactionsItemAddress.optional()),
});

export declare namespace CreateCommentResponseThreadReactionsItem {
    interface Raw {
        id?: number | null;
        address_id: number;
        reaction: "like";
        ...
        Address?: CreateCommentResponseThreadReactionsItemAddress.Raw | null;
    }
}
