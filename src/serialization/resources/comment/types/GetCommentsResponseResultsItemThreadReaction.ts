...
import { GetCommentsResponseResultsItemThreadReactionAddress } from "./GetCommentsResponseResultsItemThreadReactionAddress";

export const GetCommentsResponseResultsItemThreadReaction: core.serialization.ObjectSchema<
    serializers.GetCommentsResponseResultsItemThreadReaction.Raw,
    CommonApi.GetCommentsResponseResultsItemThreadReaction
> = core.serialization.object({
    ...
    address: core.serialization.property("Address", GetCommentsResponseResultsItemThreadReactionAddress.optional()),
});

export declare namespace GetCommentsResponseResultsItemThreadReaction {
    interface Raw {
        id?: number | null;
        address_id: number;
        reaction: "like";
        ...
        Address?: GetCommentsResponseResultsItemThreadReactionAddress.Raw | null;
    }
}
