...
import { CreateCommentResponseThreadReactionAddress } from "./CreateCommentResponseThreadReactionAddress";

export const CreateCommentResponseThreadReaction: core.serialization.ObjectSchema<
    serializers.CreateCommentResponseThreadReaction.Raw,
    CommonApi.CreateCommentResponseThreadReaction
> = core.serialization.object({
    ...
    address: core.serialization.property("Address", CreateCommentResponseThreadReactionAddress.optional()),
});

export declare namespace CreateCommentResponseThreadReaction {
    interface Raw {
        id?: number | null;
        address_id: number;
        reaction: "like";
        ...
        Address?: CreateCommentResponseThreadReactionAddress.Raw | null;
    }
}
