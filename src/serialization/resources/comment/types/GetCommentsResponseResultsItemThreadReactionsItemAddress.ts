...
export const GetCommentsResponseResultsItemThreadReactionsItemAddress: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    walletId: core.serialization.property(
        "wallet_id",
        GetCommentsResponseResultsItemThreadReactionsItemAddressWalletId.optional()
    ),
    ...
    role: GetCommentsResponseResultsItemThreadReactionsItemAddressRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", GetCommentsResponseResultsItemThreadReactionsItemAddressUser.optional()),
