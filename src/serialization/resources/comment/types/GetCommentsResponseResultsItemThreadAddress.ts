...
export const GetCommentsResponseResultsItemThreadAddress: core.serialization.ObjectSchema<
    serializers.GetCommentsResponseResultsItemThreadAddress.Raw,
    CommonApi.GetCommentsResponseResultsItemThreadAddress
> = core.serialization.object({
    ...
    walletId: core.serialization.property("wallet_id", GetCommentsResponseResultsItemThreadAddressWalletId.optional()),
    ...
    role: GetCommentsResponseResultsItemThreadAddressRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", GetCommentsResponseResultsItemThreadAddressUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace GetCommentsResponseResultsItemThreadAddress {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: GetCommentsResponseResultsItemThreadAddressWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: GetCommentsResponseResultsItemThreadAddressRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: GetCommentsResponseResultsItemThreadAddressUser.Raw | null;
