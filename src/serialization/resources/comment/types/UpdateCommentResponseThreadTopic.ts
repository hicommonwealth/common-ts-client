...
export const UpdateCommentResponseThreadTopic: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        UpdateCommentResponseThreadTopicWeightedVoting.optional()
    ),
...
export declare namespace UpdateCommentResponseThreadTopic {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: UpdateCommentResponseThreadTopicWeightedVoting.Raw | null;
