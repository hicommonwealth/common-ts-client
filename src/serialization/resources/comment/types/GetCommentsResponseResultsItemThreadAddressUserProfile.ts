...
export const GetCommentsResponseResultsItemThreadAddressUserProfile: core.serialization.ObjectSchema<
    serializers.GetCommentsResponseResultsItemThreadAddressUserProfile.Raw,
    CommonApi.GetCommentsResponseResultsItemThreadAddressUserProfile
> = core.serialization.object({
    ...
    backgroundImage: core.serialization.property(
        "background_image",
        GetCommentsResponseResultsItemThreadAddressUserProfileBackgroundImage.optional()
    ),
});
