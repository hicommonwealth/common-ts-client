...
export const CreateCommentResponseThreadCollaboratorsItem: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    walletId: core.serialization.property("wallet_id", CreateCommentResponseThreadCollaboratorsItemWalletId.optional()),
    ...
    user: core.serialization.property("User", CreateCommentResponseThreadCollaboratorsItemUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace CreateCommentResponseThreadCollaboratorsItem {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: CreateCommentResponseThreadCollaboratorsItemWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: CreateCommentResponseThreadCollaboratorsItemRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: CreateCommentResponseThreadCollaboratorsItemUser.Raw | null;
