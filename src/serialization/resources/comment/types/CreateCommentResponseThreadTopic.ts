...
import { CreateCommentResponseThreadTopicWeightedVoting } from "./CreateCommentResponseThreadTopicWeightedVoting";

export const CreateCommentResponseThreadTopic: core.serialization.ObjectSchema<
    serializers.CreateCommentResponseThreadTopic.Raw,
    CommonApi.CreateCommentResponseThreadTopic
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        CreateCommentResponseThreadTopicWeightedVoting.optional()
    ),
...
export declare namespace CreateCommentResponseThreadTopic {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: CreateCommentResponseThreadTopicWeightedVoting.Raw | null;
