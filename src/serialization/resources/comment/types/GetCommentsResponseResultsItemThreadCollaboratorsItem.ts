...
export const GetCommentsResponseResultsItemThreadCollaboratorsItem: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    walletId: core.serialization.property(
        "wallet_id",
        GetCommentsResponseResultsItemThreadCollaboratorsItemWalletId.optional()
    ),
    ...
    role: GetCommentsResponseResultsItemThreadCollaboratorsItemRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", GetCommentsResponseResultsItemThreadCollaboratorsItemUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace GetCommentsResponseResultsItemThreadCollaboratorsItem {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: GetCommentsResponseResultsItemThreadCollaboratorsItemWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: GetCommentsResponseResultsItemThreadCollaboratorsItemRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: GetCommentsResponseResultsItemThreadCollaboratorsItemUser.Raw | null;
