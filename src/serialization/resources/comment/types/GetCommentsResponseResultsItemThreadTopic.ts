...
export const GetCommentsResponseResultsItemThreadTopic: core.serialization.ObjectSchema<
...
export declare namespace GetCommentsResponseResultsItemThreadTopic {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: GetCommentsResponseResultsItemThreadTopicWeightedVoting.Raw | null;
