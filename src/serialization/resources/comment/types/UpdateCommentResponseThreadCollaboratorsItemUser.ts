...
export const UpdateCommentResponseThreadCollaboratorsItemUser: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    emailNotificationInterval: UpdateCommentResponseThreadCollaboratorsItemUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
        "ProfileTags",
        core.serialization.list(UpdateCommentResponseThreadCollaboratorsItemUserProfileTagsItem).optional()
    ),
    apiKey: core.serialization.property("ApiKey", UpdateCommentResponseThreadCollaboratorsItemUserApiKey.optional()),
...
export declare namespace UpdateCommentResponseThreadCollaboratorsItemUser {
    interface Raw {
        ...
        ProfileTags?: UpdateCommentResponseThreadCollaboratorsItemUserProfileTagsItem.Raw[] | null;
