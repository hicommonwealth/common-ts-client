...
export const CreateCommentResponseThreadAddress: core.serialization.ObjectSchema<
    serializers.CreateCommentResponseThreadAddress.Raw,
    CommonApi.CreateCommentResponseThreadAddress
> = core.serialization.object({
    ...
    walletId: core.serialization.property("wallet_id", CreateCommentResponseThreadAddressWalletId.optional()),
    ...
    role: CreateCommentResponseThreadAddressRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", CreateCommentResponseThreadAddressUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace CreateCommentResponseThreadAddress {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: CreateCommentResponseThreadAddressWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: CreateCommentResponseThreadAddressRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: CreateCommentResponseThreadAddressUser.Raw | null;
