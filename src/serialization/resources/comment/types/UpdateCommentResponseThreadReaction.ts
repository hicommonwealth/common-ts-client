...
import { UpdateCommentResponseThreadReactionAddress } from "./UpdateCommentResponseThreadReactionAddress";

export const UpdateCommentResponseThreadReaction: core.serialization.ObjectSchema<
    serializers.UpdateCommentResponseThreadReaction.Raw,
    CommonApi.UpdateCommentResponseThreadReaction
> = core.serialization.object({
    ...
    address: core.serialization.property("Address", UpdateCommentResponseThreadReactionAddress.optional()),
});

export declare namespace UpdateCommentResponseThreadReaction {
    interface Raw {
        id?: number | null;
        address_id: number;
        reaction: "like";
        ...
        Address?: UpdateCommentResponseThreadReactionAddress.Raw | null;
    }
}
