...
import { GetCommunitiesResponseResultsItemTopicsItemWeightedVoting } from "./GetCommunitiesResponseResultsItemTopicsItemWeightedVoting";

export const GetCommunitiesResponseResultsItemTopicsItem: core.serialization.ObjectSchema<
    serializers.GetCommunitiesResponseResultsItemTopicsItem.Raw,
    CommonApi.GetCommunitiesResponseResultsItemTopicsItem
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        GetCommunitiesResponseResultsItemTopicsItemWeightedVoting.optional()
    ),
...
export declare namespace GetCommunitiesResponseResultsItemTopicsItem {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: GetCommunitiesResponseResultsItemTopicsItemWeightedVoting.Raw | null;
