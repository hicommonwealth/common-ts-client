...
export const CreateCommunityResponseCommunityAddressesItem: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    walletId: core.serialization.property(
        "wallet_id",
        CreateCommunityResponseCommunityAddressesItemWalletId.optional()
    ),
    ...
    role: CreateCommunityResponseCommunityAddressesItemRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", CreateCommunityResponseCommunityAddressesItemUser.optional()),
