...
export const GetCommunitiesResponseResultsItemAddressesItem: core.serialization.ObjectSchema<
    serializers.GetCommunitiesResponseResultsItemAddressesItem.Raw,
    CommonApi.GetCommunitiesResponseResultsItemAddressesItem
> = core.serialization.object({
    ...
    user: core.serialization.property("User", GetCommunitiesResponseResultsItemAddressesItemUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace GetCommunitiesResponseResultsItemAddressesItem {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: GetCommunitiesResponseResultsItemAddressesItemWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: GetCommunitiesResponseResultsItemAddressesItemRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: GetCommunitiesResponseResultsItemAddressesItemUser.Raw | null;
