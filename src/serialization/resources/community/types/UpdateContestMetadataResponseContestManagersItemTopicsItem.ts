...
import { UpdateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting } from "./UpdateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting";

export const UpdateContestMetadataResponseContestManagersItemTopicsItem: core.serialization.ObjectSchema<
    serializers.UpdateContestMetadataResponseContestManagersItemTopicsItem.Raw,
    CommonApi.UpdateContestMetadataResponseContestManagersItemTopicsItem
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        UpdateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting.optional()
    ),
...
export declare namespace UpdateContestMetadataResponseContestManagersItemTopicsItem {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: UpdateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting.Raw | null;
