...
import { CreateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting } from "./CreateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting";

export const CreateContestMetadataResponseContestManagersItemTopicsItem: core.serialization.ObjectSchema<
    serializers.CreateContestMetadataResponseContestManagersItemTopicsItem.Raw,
    CommonApi.CreateContestMetadataResponseContestManagersItemTopicsItem
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        CreateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting.optional()
    ),
...
export declare namespace CreateContestMetadataResponseContestManagersItemTopicsItem {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: CreateContestMetadataResponseContestManagersItemTopicsItemWeightedVoting.Raw | null;
