...
export const GetCommunityResponseAddressesAddressesItemUser: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    emailNotificationInterval: GetCommunityResponseAddressesAddressesItemUserEmailNotificationInterval.optional(),
    ...
    profileTags: core.serialization.property(
        "ProfileTags",
        core.serialization.list(GetCommunityResponseAddressesAddressesItemUserProfileTagsItem).optional()
    ),
    apiKey: core.serialization.property("ApiKey", GetCommunityResponseAddressesAddressesItemUserApiKey.optional()),
