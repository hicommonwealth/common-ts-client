...
import { GetTopicsResponseItemActiveContestManagersItemContentItemAction } from "./GetTopicsResponseItemActiveContestManagersItemContentItemAction";

export const GetTopicsResponseItemActiveContestManagersItemContentItem: core.serialization.ObjectSchema<
    serializers.GetTopicsResponseItemActiveContestManagersItemContentItem.Raw,
    CommonApi.GetTopicsResponseItemActiveContestManagersItemContentItem
> = core.serialization.object({
    ...
    action: GetTopicsResponseItemActiveContestManagersItemContentItemAction,
...
export declare namespace GetTopicsResponseItemActiveContestManagersItemContentItem {
    interface Raw {
        contest_address: string;
        contest_id: number;
        content_id: number;
        actor_address: string;
        action: GetTopicsResponseItemActiveContestManagersItemContentItemAction.Raw;
