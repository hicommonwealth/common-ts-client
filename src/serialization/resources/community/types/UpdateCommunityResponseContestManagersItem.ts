...
export const UpdateCommunityResponseContestManagersItem: core.serialization.ObjectSchema<
    serializers.UpdateCommunityResponseContestManagersItem.Raw,
    CommonApi.UpdateCommunityResponseContestManagersItem
> = core.serialization.object({
    ...
    contests: core.serialization.list(UpdateCommunityResponseContestManagersItemContestsItem).optional(),
    ...
    topics: core.serialization.list(UpdateCommunityResponseContestManagersItemTopicsItem).optional(),
    isFarcasterContest: core.serialization.property("is_farcaster_contest", core.serialization.boolean()),
});

export declare namespace UpdateCommunityResponseContestManagersItem {
    interface Raw {
        ...
        ended?: boolean | null;
        contests?: UpdateCommunityResponseContestManagersItemContestsItem.Raw[] | null;
        ...
        topics?: UpdateCommunityResponseContestManagersItemTopicsItem.Raw[] | null;
