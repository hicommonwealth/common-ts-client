...
import { CancelContestMetadataResponseContestManagersItemTopicsItemWeightedVoting } from "./CancelContestMetadataResponseContestManagersItemTopicsItemWeightedVoting";

export const CancelContestMetadataResponseContestManagersItemTopicsItem: core.serialization.ObjectSchema<
    serializers.CancelContestMetadataResponseContestManagersItemTopicsItem.Raw,
    CommonApi.CancelContestMetadataResponseContestManagersItemTopicsItem
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        CancelContestMetadataResponseContestManagersItemTopicsItemWeightedVoting.optional()
    ),
...
export declare namespace CancelContestMetadataResponseContestManagersItemTopicsItem {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: CancelContestMetadataResponseContestManagersItemTopicsItemWeightedVoting.Raw | null;
