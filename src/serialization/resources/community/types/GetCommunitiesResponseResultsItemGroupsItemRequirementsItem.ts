...
export const GetCommunitiesResponseResultsItemGroupsItemRequirementsItem: core.serialization.Schema<
...
> = core.serialization
    .union("rule", {
        threshold: GetCommunitiesResponseResultsItemGroupsItemRequirementsItemThreshold,
        allow: GetCommunitiesResponseResultsItemGroupsItemRequirementsItemAllow,
    })
    .transform<CommonApi.GetCommunitiesResponseResultsItemGroupsItemRequirementsItem>({
...
export declare namespace GetCommunitiesResponseResultsItemGroupsItemRequirementsItem {
    ...
    interface Threshold extends GetCommunitiesResponseResultsItemGroupsItemRequirementsItemThreshold.Raw {
        rule: "threshold";
    }

    interface Allow extends GetCommunitiesResponseResultsItemGroupsItemRequirementsItemAllow.Raw {
        rule: "allow";
    }
}
