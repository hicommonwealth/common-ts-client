...
export const GetCommunitiesResponseResultsItemCommunityStakesItem: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    stakeTransactions: core.serialization.property(
        "StakeTransactions",
        core.serialization.list(GetCommunitiesResponseResultsItemCommunityStakesItemStakeTransactionsItem).optional()
    ),
