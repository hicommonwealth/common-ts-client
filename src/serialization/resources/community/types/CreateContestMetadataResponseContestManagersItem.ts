...
import { CreateContestMetadataResponseContestManagersItemContestsItem } from "./CreateContestMetadataResponseContestManagersItemContestsItem";
import { CreateContestMetadataResponseContestManagersItemTopicsItem } from "./CreateContestMetadataResponseContestManagersItemTopicsItem";

export const CreateContestMetadataResponseContestManagersItem: core.serialization.ObjectSchema<
    serializers.CreateContestMetadataResponseContestManagersItem.Raw,
    CommonApi.CreateContestMetadataResponseContestManagersItem
> = core.serialization.object({
    ...
    contests: core.serialization.list(CreateContestMetadataResponseContestManagersItemContestsItem).optional(),
    ...
    topics: core.serialization.list(CreateContestMetadataResponseContestManagersItemTopicsItem).optional(),
    isFarcasterContest: core.serialization.property("is_farcaster_contest", core.serialization.boolean()),
});

export declare namespace CreateContestMetadataResponseContestManagersItem {
    interface Raw {
        ...
        ended?: boolean | null;
        contests?: CreateContestMetadataResponseContestManagersItemContestsItem.Raw[] | null;
        ...
        topics?: CreateContestMetadataResponseContestManagersItemTopicsItem.Raw[] | null;
