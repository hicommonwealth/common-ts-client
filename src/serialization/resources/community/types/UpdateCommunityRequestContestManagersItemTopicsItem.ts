...
import { UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting } from "./UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting";

export const UpdateCommunityRequestContestManagersItemTopicsItem: core.serialization.ObjectSchema<
    serializers.UpdateCommunityRequestContestManagersItemTopicsItem.Raw,
    CommonApi.UpdateCommunityRequestContestManagersItemTopicsItem
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting.optional()
    ),
...
export declare namespace UpdateCommunityRequestContestManagersItemTopicsItem {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: UpdateCommunityRequestContestManagersItemTopicsItemWeightedVoting.Raw | null;
