...
import { CancelContestMetadataResponseContestManagersItemContestsItem } from "./CancelContestMetadataResponseContestManagersItemContestsItem";
import { CancelContestMetadataResponseContestManagersItemTopicsItem } from "./CancelContestMetadataResponseContestManagersItemTopicsItem";

export const CancelContestMetadataResponseContestManagersItem: core.serialization.ObjectSchema<
    serializers.CancelContestMetadataResponseContestManagersItem.Raw,
    CommonApi.CancelContestMetadataResponseContestManagersItem
> = core.serialization.object({
    ...
    contests: core.serialization.list(CancelContestMetadataResponseContestManagersItemContestsItem).optional(),
    ...
    topics: core.serialization.list(CancelContestMetadataResponseContestManagersItemTopicsItem).optional(),
    isFarcasterContest: core.serialization.property("is_farcaster_contest", core.serialization.boolean()),
});

export declare namespace CancelContestMetadataResponseContestManagersItem {
    interface Raw {
        ...
        ended?: boolean | null;
        contests?: CancelContestMetadataResponseContestManagersItemContestsItem.Raw[] | null;
        ...
        topics?: CancelContestMetadataResponseContestManagersItemTopicsItem.Raw[] | null;
