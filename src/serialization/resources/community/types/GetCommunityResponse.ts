...
export const GetCommunityResponse: core.serialization.Schema<
    serializers.GetCommunityResponse.Raw,
    CommonApi.GetCommunityResponse
> = core.serialization.undiscriminatedUnion([GetCommunityResponseAddresses, core.serialization.unknown()]);
