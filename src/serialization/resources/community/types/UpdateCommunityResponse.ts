...
export const UpdateCommunityResponse: core.serialization.ObjectSchema<
...
> = core.serialization.object({
    ...
    defaultPage: core.serialization.property("default_page", UpdateCommunityResponseDefaultPage.optional()),
    hasHomepage: core.serialization.property("has_homepage", UpdateCommunityResponseHasHomepage.optional()),
    ...
    communityStakes: core.serialization.property(
        "CommunityStakes",
        core.serialization.list(UpdateCommunityResponseCommunityStakesItem).optional()
    ),
    communityTags: core.serialization.property(
        "CommunityTags",
        core.serialization.list(UpdateCommunityResponseCommunityTagsItem).optional()
    ),
    chainNode: core.serialization.property("ChainNode", UpdateCommunityResponseChainNode.optional()),
    ...
    contestManagers: core.serialization.property(
        "contest_managers",
        core.serialization.list(UpdateCommunityResponseContestManagersItem).optional()
    ),
});
