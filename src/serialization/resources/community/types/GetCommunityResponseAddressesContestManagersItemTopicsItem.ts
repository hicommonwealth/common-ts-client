...
import { GetCommunityResponseAddressesContestManagersItemTopicsItemWeightedVoting } from "./GetCommunityResponseAddressesContestManagersItemTopicsItemWeightedVoting";

export const GetCommunityResponseAddressesContestManagersItemTopicsItem: core.serialization.ObjectSchema<
    serializers.GetCommunityResponseAddressesContestManagersItemTopicsItem.Raw,
    CommonApi.GetCommunityResponseAddressesContestManagersItemTopicsItem
> = core.serialization.object({
    ...
    weightedVoting: core.serialization.property(
        "weighted_voting",
        GetCommunityResponseAddressesContestManagersItemTopicsItemWeightedVoting.optional()
    ),
...
export declare namespace GetCommunityResponseAddressesContestManagersItemTopicsItem {
    interface Raw {
        id?: number | null;
        name?: string | null;
        community_id: string;
        ...
        weighted_voting?: GetCommunityResponseAddressesContestManagersItemTopicsItemWeightedVoting.Raw | null;
