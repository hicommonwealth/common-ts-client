...
export const GetCommunityResponseAddressesCommunityStakesItem: core.serialization.ObjectSchema<
    serializers.GetCommunityResponseAddressesCommunityStakesItem.Raw,
    CommonApi.GetCommunityResponseAddressesCommunityStakesItem
> = core.serialization.object({
    ...
    stakeTransactions: core.serialization.property(
        "StakeTransactions",
        core.serialization.list(GetCommunityResponseAddressesCommunityStakesItemStakeTransactionsItem).optional()
    ),
