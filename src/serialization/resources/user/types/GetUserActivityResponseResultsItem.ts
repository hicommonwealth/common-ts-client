...
import { GetUserActivityResponseResultsItemDiscordMeta } from "./GetUserActivityResponseResultsItemDiscordMeta";
import { GetUserActivityResponseResultsItemTopic } from "./GetUserActivityResponseResultsItemTopic";
import { GetUserActivityResponseResultsItemRecentCommentsItem } from "./GetUserActivityResponseResultsItemRecentCommentsItem";

export const GetUserActivityResponseResultsItem: core.serialization.ObjectSchema<
    serializers.GetUserActivityResponseResultsItem.Raw,
    CommonApi.GetUserActivityResponseResultsItem
> = core.serialization.object({
    ...
    discordMeta: core.serialization.property("discord_meta", GetUserActivityResponseResultsItemDiscordMeta.optional()),
    topic: GetUserActivityResponseResultsItemTopic,
    recentComments: core.serialization.property(
        "recent_comments",
        core.serialization.list(GetUserActivityResponseResultsItemRecentCommentsItem).optional()
    ),
});

export declare namespace GetUserActivityResponseResultsItem {
    interface Raw {
        community_id: string;
        ...
        discord_meta?: GetUserActivityResponseResultsItemDiscordMeta.Raw | null;
        topic: GetUserActivityResponseResultsItemTopic.Raw;
        recent_comments?: GetUserActivityResponseResultsItemRecentCommentsItem.Raw[] | null;
    }
}
