...
import { GetUserActivityResponseResultsItemRecentCommentsItemDiscordMeta } from "./GetUserActivityResponseResultsItemRecentCommentsItemDiscordMeta";

export const GetUserActivityResponseResultsItemRecentCommentsItem: core.serialization.ObjectSchema<
    serializers.GetUserActivityResponseResultsItemRecentCommentsItem.Raw,
    CommonApi.GetUserActivityResponseResultsItemRecentCommentsItem
> = core.serialization.object({
    ...
    discordMeta: core.serialization.property(
        "discord_meta",
        GetUserActivityResponseResultsItemRecentCommentsItemDiscordMeta.optional()
    ),
});

export declare namespace GetUserActivityResponseResultsItemRecentCommentsItem {
    interface Raw {
        id: number;
        address: string;
        user_id?: number | null;
        ...
        discord_meta?: GetUserActivityResponseResultsItemRecentCommentsItemDiscordMeta.Raw | null;
    }
}
