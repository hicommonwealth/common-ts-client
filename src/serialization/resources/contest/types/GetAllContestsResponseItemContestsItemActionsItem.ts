...
import { GetAllContestsResponseItemContestsItemActionsItemAction } from "./GetAllContestsResponseItemContestsItemActionsItemAction";

export const GetAllContestsResponseItemContestsItemActionsItem: core.serialization.ObjectSchema<
    serializers.GetAllContestsResponseItemContestsItemActionsItem.Raw,
    CommonApi.GetAllContestsResponseItemContestsItemActionsItem
> = core.serialization.object({
    ...
    action: GetAllContestsResponseItemContestsItemActionsItemAction,
...
export declare namespace GetAllContestsResponseItemContestsItemActionsItem {
    interface Raw {
        contest_address: string;
        contest_id: number;
        content_id: number;
        actor_address: string;
        action: GetAllContestsResponseItemContestsItemActionsItemAction.Raw;
