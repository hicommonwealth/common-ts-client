...
import { GetAllContestsResponseItemContestsItem } from "./GetAllContestsResponseItemContestsItem";
import { GetAllContestsResponseItemTopicsItem } from "./GetAllContestsResponseItemTopicsItem";

export const GetAllContestsResponseItem: core.serialization.ObjectSchema<
    serializers.GetAllContestsResponseItem.Raw,
...
> = core.serialization.object({
    ...
    contests: core.serialization.list(GetAllContestsResponseItemContestsItem),
    ...
    topics: core.serialization.list(GetAllContestsResponseItemTopicsItem),
    isFarcasterContest: core.serialization.property("is_farcaster_contest", core.serialization.boolean()),
});

export declare namespace GetAllContestsResponseItem {
    interface Raw {
        ...
        ended?: boolean | null;
        contests: GetAllContestsResponseItemContestsItem.Raw[];
        ...
        topics: GetAllContestsResponseItemTopicsItem.Raw[];
