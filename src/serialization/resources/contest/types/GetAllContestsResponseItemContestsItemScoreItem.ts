...
export const GetAllContestsResponseItemContestsItemScoreItem: core.serialization.ObjectSchema<
    serializers.GetAllContestsResponseItemContestsItemScoreItem.Raw,
    CommonApi.GetAllContestsResponseItemContestsItemScoreItem
...
export declare namespace GetAllContestsResponseItemContestsItemScoreItem {
    interface Raw {
