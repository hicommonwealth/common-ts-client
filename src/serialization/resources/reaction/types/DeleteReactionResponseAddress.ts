...
import { DeleteReactionResponseAddressWalletId } from "./DeleteReactionResponseAddressWalletId";
import { DeleteReactionResponseAddressRole } from "./DeleteReactionResponseAddressRole";
import { DeleteReactionResponseAddressUser } from "./DeleteReactionResponseAddressUser";

export const DeleteReactionResponseAddress: core.serialization.ObjectSchema<
    serializers.DeleteReactionResponseAddress.Raw,
    CommonApi.DeleteReactionResponseAddress
> = core.serialization.object({
    ...
    walletId: core.serialization.property("wallet_id", DeleteReactionResponseAddressWalletId.optional()),
    ...
    role: DeleteReactionResponseAddressRole.optional(),
    isBanned: core.serialization.property("is_banned", core.serialization.boolean().optional()),
    hex: core.serialization.string().optional(),
    user: core.serialization.property("User", DeleteReactionResponseAddressUser.optional()),
    createdAt: core.serialization.property("created_at", core.serialization.date().optional()),
    updatedAt: core.serialization.property("updated_at", core.serialization.date().optional()),
});

export declare namespace DeleteReactionResponseAddress {
    interface Raw {
        id?: number | null;
        address: string;
        community_id: string;
        ...
        wallet_id?: DeleteReactionResponseAddressWalletId.Raw | null;
        block_info?: string | null;
        is_user_default?: boolean | null;
        role?: DeleteReactionResponseAddressRole.Raw | null;
        is_banned?: boolean | null;
        hex?: string | null;
        User?: DeleteReactionResponseAddressUser.Raw | null;
